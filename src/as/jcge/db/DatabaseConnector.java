...
{	
	 ...
	 * @return
	 */
	public int insertMethod(Method method, String commitId) {
		int id = getMethodID(method, commitId);
		if(id != -1)
			return updateMethodLines(method, id, commitId);
	 ...
	 * @return
	 */
	private int updateMethodLines(Method method, int id, String commitId) {
	 ...
	 * @return
	 */
	public int getMethodID(Method method, String commitId) {
		try {
			// Set up parameters
			String parameters = "{";
			if(!method.getParameters().isEmpty()) {
	 ...
	 * @param callee
	 */
	public void insertInvokes(int caller, int callee, String commitId) {
	 ...
	 * @return
	 */
	public List<Pair<Method, Float>> getChangedMethods(String file, int start, int end, String commitId) {
	 ...
	 * @return
	 */
	public List<Method> getCallersOfMethod(Method method, String commitId) {
